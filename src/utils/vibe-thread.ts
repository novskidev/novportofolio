type VibeThreadWindow = Window & {
  __novskidevVibeThreadCleanup?: () => void;
  __novskidevVibeThreadEvents?: boolean;
};
...
const clearVibeThread = (): void => {
  ...
  vibeWindow.__novskidevVibeThreadCleanup?.();
  vibeWindow.__novskidevVibeThreadCleanup = undefined;
};
...
const mountCurrentVibeThread = (): void => {
  ...
  getVibeThreadWindow().__novskidevVibeThreadCleanup = () => {
...
export const mountVibeThread = (): void => {
  ...
  if (!vibeWindow.__novskidevVibeThreadEvents) {
    vibeWindow.__novskidevVibeThreadEvents = true;
